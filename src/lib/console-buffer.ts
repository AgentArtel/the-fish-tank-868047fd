// Lightweight console ring buffer for the feedback dock. Browsers don't expose
// past console history, so we record forward from app load: the last N error/warn
// entries plus uncaught errors and unhandled promise rejections. Capturing is
// best-effort and must never throw into the app.
